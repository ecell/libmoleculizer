...
#include "cft/cftUnit.hh"

namespace cpt
{
  unitsMgr::
  unitsMgr(cptApp& rCptApp) :
    pCptUnit(new cpt::cptUnit(rCptApp)),
    pCstUnit(new cst::cstUnit(rCptApp,
			      *pCptUnit)),
    pCmlUnit(new cml::cmlUnit(rCptApp)),
    pClxUnit(new clx::clxUnit(rCptApp,
			      *pCptUnit,
			      *pCmlUnit)),
    pCdmUnit(new cdm::cdmUnit(rCptApp,
			      *pCptUnit,
			      *pCmlUnit,
			      *pClxUnit)),
    pCftUnit(new cft::cftUnit(rCptApp,
    			      *pCptUnit,
    			      *pCmlUnit,
    			      *pClxUnit))
  {
