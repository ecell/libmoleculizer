...
namespace stoch
{
  ...
  class stochUnit : public mzr::unit
  {
    mzr::autoCatalog<stochSpecies> stochSpeciesByName;
    std::vector<mzr::reaction*> noSubstrateArrows;
  ...
  public:
    ...
    void
    addNoSubstrateArrow(mzr::reaction* pArrow);
