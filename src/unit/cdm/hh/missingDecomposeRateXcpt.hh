...
#ifndef CDM_MISSINGDECOMPOSERATEXCPT_H
#define CDM_MISSINGDECOMPOSERATEXCPT_H
...
namespace cdm
{
  ...
  {
    static std::string
    mkMsg(const cpx::cxBinding<clx::cptPlexSpecies, clx::cptPlexFamily>& cx);

  public:
    missingDecomposeRateXcpt
    (const cpx::cxBinding<clx::cptPlexSpecies, clx::cptPlexFamily>& cx) :
      utl::xcpt(mkMsg(cx))
    {}
  };
}

#endif // CDM_MISSINGDECOMPOSERATEXCPT_H
