...
namespace odie
{
  namespace odieEltName
  {
    ...
    const std::string epsilonAbs("epsilon-abs");
    const std::string epsilonAbs_valueAttr("value");
    const std::string epsilonRel("epsilon-rel");
    const std::string epsilonRel_valueAttr("value");
    const std::string stateScalar("state-scalar");
    const std::string stateScalar_valueAttr("value");
    const std::string derivScalar("deriv-scalar");;
    const std::string derivScalar_valueAttr("value");
  }
}
