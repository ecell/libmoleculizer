...
namespace kinase
{
  class nucBindFam : public mzr::reactionFamily
  {
    nucBindRxnGen generator;
  public:
    nucBindFam(bnd::modMol* pNucBindMol,
	       int nucModSiteNdx,
      ...
      generator(pNucBindMol,
		...
		this,
		rMzrUnit,
		pNucBindExtrapolator,
		pNucUnbindExtrapolator)
    {}
