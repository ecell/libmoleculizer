...
#ifndef GPAEXCHANGEFAM_H
#define GPAEXCHANGEFAM_H
...
namespace gpa
{
  class gpaExchangeFam : public mzr::reactionFamily
  {
    gpaExchangeRxnGen generator;

  public:

    gpaExchangeFam(bnd::modMol* pGpaMol,
