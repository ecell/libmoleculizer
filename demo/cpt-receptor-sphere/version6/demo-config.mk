...
$(OUTPUT_DIR)/five-total-membranes-sec15-20-c4.dmp : $(OUTPUT_DIR)/five-total-membranes-sec15-20.dmp
	cut -f1,4 $< > $@
...
$(OUTPUT_DIR)/plots-done : \
	...
	$(OUTPUT_DIR)/five-total-membranes-sec15-20-c4.dmp \
	$(OUTPUT_DIR)/headers-fixed
	cd $(@D) && plot-dmp-files
	touch $@
