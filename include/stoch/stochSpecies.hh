...
{
  /*! \ingroup stochGroup
    \brief A simple molecule with no binding sites.

    This is the class for "small molecules." The "small-molecule"
    command defines one of these.  It actually has slightly more
    information than a species in Stochastirator would have, since
