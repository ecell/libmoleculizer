...
/*! \file eventQueue.hh
  \ingroup eventGroup
  \brief Defines eventQueue, the moleculizer event schedule. */
...
namespace mzr
{
  ...
  /*! \ingroup eventGroup
    \brief The moleculizer event schedule. */
  class eventQueue :
    public std::multimap<double, event*>
  {
  ...
  public:
    ...
    void
    descheduleEvent(event* pEvent);

    //! Schedule or reschedule an event.
    void
    scheduleEvent(event* pEvent,
		  double time);
