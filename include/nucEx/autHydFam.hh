...
namespace nucEx
{
  // A family of auto-hydrolysis reactions for a nucleotide binding
  // protein, such as Gpa1.

  class autHydFam : public mzr::reactionFamily
  {
    autHydRxnGen generator;
  public:
    autHydFam(bnd::modMol* pAutHydMol,
	      int nucModSiteNdx,
