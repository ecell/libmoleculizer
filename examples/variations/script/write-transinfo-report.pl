...
($transinfo_file_stem, $variations_file, $output_dir) = @ARGV;
...
print "write-transinfo-report.pl: output-directory is $output_dir.\n";

$report_file = "$output_dir/tddrs/$transinfo_file_stem--report";
...
while(<VARIATIONS>)
{
    ...
    $variation_transinfo_file = "$output_dir/$variation_dir/tddrs/$transinfo_file_stem--transinfo";
...
$mixed_transinfo_file = "$output_dir/tddrs/$transinfo_file_stem--transinfo";
