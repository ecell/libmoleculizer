...
DOT := $(DOT)/heinrich-rk4tau

$(DOT)/target : $(DOT)/heinrich-rk4tau.out $(DOT)/heinrich.out

$(DOT)/heinrich-rk4tau.out : $(DOT)/heinrich-rk4tau.xml
	mkdir $@
	cp $? $@
	cd $@ \
	&& rk4tau < heinrich-rk4tau.xml \
	&& plot-dmp-files

# As usual, this odie file needs a little hand-editing to correct some
# rk4tau-specific parameters.
$(DOT)/heinrich-rk4tau.xml.out : $(DOT)/heinrich.out
