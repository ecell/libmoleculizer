...
$(DEMO_DIR)/target : $(OUTPUT_DIR)/state-dump-pretty.sbml $(DOC_INPUT_HTML)
...
# Convert state dump to sbml.  Consider converting the state dump to HTML?
