...
#ifndef CFT_OMNIEXTRAP_H
#define CFT_OMNIEXTRAP_H
...
namespace cft
{
  ...
  public:
    ...
    virtual
    double
    getRate(const cpx::cxOmni<cml::cptMol, clx::cptPlexSpecies, clx::cptPlexFamily, clx::cptOmniPlex>& rContext) const = 0;
  };
  ...
  public:
    ...
    double
    getRate(const cpx::cxOmni<cml::cptMol, clx::cptPlexSpecies, clx::cptPlexFamily, clx::cptOmniPlex>& rContext) const
    {
      return rate;
    }
  };
