...
#ifndef CML_BADMODMOLXCPT_H
#define CML_BADMODMOLXCPT_H
...
namespace cml
{
  ...
  const cptModMol*
  mustBeModMol(const cptMol* pMol,
	       const xmlpp::Node* pRequestingNode = 0)
    throw(badModMolXcpt);
}

#endif // CML_BADMODMOLXCPT_H
