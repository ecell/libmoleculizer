...
#ifndef CLX_CPTOMNIPLEX_H
#define CLX_CPTOMNIPLEX_H
...
namespace clx
{
  class cptOmniPlex : public
  cpx::omniPlex<cml::cptMol,
		      cptPlex,
		      cptPlexSpecies,
		      cptPlexFamily,
		      cptOmniPlex>
  {
  public:
    cptOmniPlex(cptPlexFamily* pPlexFamily,
