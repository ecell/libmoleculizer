...
namespace mzr
{
  ...
  public:
	...
	= domUtils::mustBeElementPtr(pExplicitSpeciesTagNode);

      std::string speciesName
	= domUtils::mustGetAttrString(pExplicitSpeciesTagElt,
    ...
    throw(std::exception)
  {
    ...
    xmlpp::Element* pInputModelElement
      = domUtils::mustGetUniqueChild(pInputRootElement,
				     eltName::model);
    ...
    xmlpp::Element* pStateModelElement
      = domUtils::mustGetUniqueChild(pStateRootElement,
				     eltName::model);
    xmlpp::Element* pStateTaggedSpeciesElement
      = domUtils::mustGetUniqueChild(pStateModelElement,
    ...
    double dumpTime
      = domUtils::mustGetAttrDouble(pTimeElement,
