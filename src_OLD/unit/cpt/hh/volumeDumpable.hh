...
#ifndef CPT_VOLUMEDUMPABLE_H
#define CPT_VOLUMEDUMPABLE_H
...
namespace cpt
{
  ...
  // Depending on the globalDumpArg, this will dump the volumes of several
  // compartments in separate columns, or dump the total volume of several
  // compartments in a single column.
