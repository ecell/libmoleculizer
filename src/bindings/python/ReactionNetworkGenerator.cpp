...
//     std::string speciesTag1;
//     std::

//     const mzr::mzrSpecies* pSpeciesOne = ptrMoleculizer->getSpeciesWithName( species1 );
//     const mzr::mzrSpecies* pSpeciesTwo = ptrMoleculizer->getSpeciesWithName( species2 );
