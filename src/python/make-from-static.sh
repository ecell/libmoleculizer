...
g++ -shared -o Moleculizer.so ReactionNetworkGenerator.o Moleculizer.o -L/home/naddy/usr/lib -lboost_python -lxml++-2.6 -lxml2 -lglibmm-2.4 -lgobject-2.0 -lsigc-2.0 -lglib-2.0  -lmoleculizer_super
