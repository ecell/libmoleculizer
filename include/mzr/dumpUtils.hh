...
namespace mzr
{
  // Inserts a stereotyped parameter value element.
  //
  // This is basically part of a fix to introduce scientific notation for all
  // parameter values so as to be able to generate, using XSLT, SBML and other
  // formats that have the fraction and exponent in separate XML constructs.
  //
  // But it might also be a good sort of thing anyway.
  void
