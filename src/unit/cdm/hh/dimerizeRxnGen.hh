...
#ifndef CDM_DIMERIZERXNGEN_H
#define CDM_DIMERIZERXNGEN_H
...
namespace cdm
{
  ...
  class dimerizeRxnGenPair :
    public fnd::binaryRxnGenPair<cml::siteFeature, cml::siteFeature>
  {
  ...
  public:
    ...
    dimerizeRxnGenPair(cml::siteFeature& rLeftSiteFeature,
		       cml::siteFeature& rRightSiteFeature,
		       utl::autoVector<cpt::globalReaction>* pDimerizeFamily,
		       cpt::cptApp& refCptApp,
		       cpt::cptUnit& refCptUnit,
		       clx::clxUnit& refClxUnit,
		       dimerizeExtrapolator* pExtrapolator) :
      fnd::binaryRxnGenPair<cml::siteFeature, cml::siteFeature>(rLeftSiteFeature,
								rRightSiteFeature),
