...
# Local executable, with extension, which is copied to bin for "target."
...
LNK_SYS  := $(addprefix -l,$(STATIC_EXTRAS))

$(LOCAL_EXE) : LNKS := $(OBJECTS) $(LNK_MODS) $(LNK_SYS)
$(LOCAL_EXE) : $(REQUIRED_ARCHIVES) $(OBJECTS) 
