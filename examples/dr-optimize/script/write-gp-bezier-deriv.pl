...
open(SCRIPT, ">$gnuplot_script") or
    die("write-bezier-deriv.pl: could not open "
...
print SCRIPT "set ylabel \"Dose-scaled derivative of response\"\n";
print SCRIPT "plot \"$histo_dir/bezier-deriv\" using 1:(\$1*\$2) with lines notitle\n";
