...
namespace cpt
{
  ...
  class cptSpeciesStream
  {
  public:
    virtual
    ~cptSpeciesStream(void)
    {}
  ...
  {
  protected:
    std::vector<const cptSpeciesStream*> speciesStreams;
  ...
  public:
    ...
    void
    addSpeciesStream(const cptSpeciesStream* pSpeciesStream)
    {
      speciesStreams.push_back(pSpeciesStream);
    }
