...
extern long *ran_arr_ptr;       /* declared in rng.c */
...
#if HAVE_TIMES
#include <sys/times.h>
#define CPUDEFS static struct tms timebuffer;
#ifndef CLK_TCK
#include <time.h>
#endif
...
{struct timeval nauty_tv; \
 ...
 seed = (nauty_tv.tv_sec<<10) + (nauty_tv.tv_usec>>10) & 017777777777L;}
#else
#if HAVE_TIME
#include <time.h>
#define INITSEED  seed = ((time((time_t*)NULL)<<1) | 1) & 017777777777L
#endif
#endif
