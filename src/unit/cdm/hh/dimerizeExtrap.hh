...
#ifndef CDM_DIMERIZEEXTRAP_H
#define CDM_DIMERIZEEXTRAP_H
...
namespace cdm
{
  ...
  public:
    ...
    getRate(const cpx::cxSite<clx::cptPlexSpecies, clx::cptPlexFamily>& rLeftContext,
	    const cpx::cxSite<clx::cptPlexSpecies, clx::cptPlexFamily>& rRightContext) const = 0;
  };
